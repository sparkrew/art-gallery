...
var sketch = function (p) {
  ...
  p.preload = function () {
    myFont = p.loadFont("art/js/data/artwork_3/game_over.ttf");
    p.loadStrings("art/js/data/artwork_3/data/pos.csv", (data) =>
      processCSV(data, "pos")
    );
    p.loadStrings("art/js/data/artwork_3/data/neg.csv", (data) =>
      processCSV(data, "neg")
    );
  };
